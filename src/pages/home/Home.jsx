...
import Banner from "../../components/DisplayBanner/DisplayBanner";
...
function Home() {
    ...
    const [categoryLookup, setCategoryLookup] = useState(createCategoryLookup(categoryData));
    ...
    const handleCardDelete = (cardId) => {
        deleteVideo(cardId);
        updateBannerCardAfterDelete(cardId);
    };

    const updateBannerCardAfterDelete = (cardId) => {
